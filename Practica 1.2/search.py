...
def tree_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print "Numero de nodos expandidos:", nodosexpandidos
            return node
...
def graph_search(problem, fringe):
    ...
    while fringe:
        node = fringe.pop()
        if problem.goal_test(node.state):
            print "Numero de nodos expandidos:", nodoexpandidos
            return node
...
def rys_tree_search(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    return tree_search(problem, RamifiJump(problem))
